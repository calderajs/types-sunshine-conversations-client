...
declare class Mailgun {
     ...
     */
    static initialize(obj: any, type: any, apiKey: any, domain: any, incomingAddress: any): void;
    /**
     ...
     */
    constructor(type: string, apiKey: string, domain: string, incomingAddress: string);
    /**
